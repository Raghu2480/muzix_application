...
public class Movie {
    ...
    public Movie(boolean adult, String backdrop_path, String belongs_to_collection, Long budget, String homepage, int id, String imdb_id, List<Genre> genres, String original_language, String original_title, String overview, double popularity, String poster_path, List<ProductionCompanies> production_companies, List<ProductionCountries> production_countries, String release_date, Long revenue, int runtime, List<SpokenLanguage> spoken_languages, String status, String tagline, String title, boolean video, float vote_average, int vote_count) {
        this.adult = adult;
